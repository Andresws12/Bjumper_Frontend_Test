...
1. [About The Project](#bjumper-frontend-test)
...
# <span id="bjumper-frontend-test">🥸Bjumper Frontend Test</span>

<font size="4">**Welcome Bjumper Frontend Test👋.**</font>
...
[URL Bjumper Frontend Test](https://andres-hernandez.com/)
...
1. Clone the repository
   ```sh
   git clone https://github.com/Andresws12/Bjumper_Frontend_Test.git
   ```
2. Open the folder and run the required commands for installation
   ```sh
   cd Bjumper_Frontend_Test
   code .
   pnpm install
   ```
